...
func (ssem *SSEMonitor) Fetch_SSEEvent() *SSE_Event {
	return SSEEventsPool.Get().(*SSE_Event)
}

func (ssem *SSEMonitor) ReStore_SSEEvent(pSSE_Event *SSE_Event) {
	SSEEventsPool.Put(pSSE_Event)
}
...
func (ssem *SSEMonitor) EventClientsCount() uint8 {
	if ssem.sseHub != nil {
